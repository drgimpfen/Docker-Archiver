...
- SMTP credentials are managed via the app UI (Settings → Notifications) and are not configured via env vars. See [SECURITY.md](./SECURITY.md) for guidance on TLS and credential handling.
